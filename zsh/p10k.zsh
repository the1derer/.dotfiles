# Generated by Powerlevel10k configuration wizard on 2020-05-01 at 11:01 IST.
...
() {
  ...
  # ZSH Configuration to have Right Prompt without any space, remove if causing any problem
  ...
  function my_git_formatter() {
    ...
    res+="${meta} "$'\uE729'" ${clean}${VCS_STATUS_COMMIT[1,6]}"
  ...
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=022
  # Custom icon.
